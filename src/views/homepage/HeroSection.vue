    ...
    <div class="relative z-10">
      <div class="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
        <div class="max-w-xl mx-auto text-center">
          ...
          <p
            class="mt-5 font-sans text-base font-normal text-white text-opacity-70"
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu
            penatibus pellentesque dolor consequat ligula egestas massa gravida.
            Porttitor venenatis enim praesent.
          </p>
          <div
            class="flex items-center justify-center mt-8 space-x-3 sm:space-x-6"
          >
            <a
              href="#"
              title=""
